...
#import "LSEditImageViewController.h"
...
@interface LSEditImageViewController () {
//    CGFloat                 kMaxUIImageSize;
//    CGFloat                 kPreviewImageSize;
//    CGFloat                 kDefaultCropWidth;
//    CGFloat                 kDefaultCropHeight;
//    CGFloat                 kBoundingBoxInset;
//    NSTimeInterval          kAnimationIntervalReset;
//    NSTimeInterval          kAnimationIntervalTransform;
}
...
@property (weak, nonatomic) IBOutlet LSEditImageFrameView           *frameView;
@property (weak, nonatomic) IBOutlet UIView                         *controlsView;
@property (weak, nonatomic) IBOutlet LSButton                       *retakeButton;
@property (weak, nonatomic) IBOutlet LSButton                       *useImageButton;

@property (weak, nonatomic) IBOutlet NSLayoutConstraint *controlsConstraint;
...
@implementation LSEditImageViewController
...
- (void)commonInit
{
//    kMaxUIImageSize                                     = 1024;
//    kPreviewImageSize                                   = 120;
//    kDefaultCropWidth                                   = 320;
//    kDefaultCropHeight                                  = 320;
//    kBoundingBoxInset                                   = 15;
//    kAnimationIntervalReset                             = 0.25;
//    kAnimationIntervalTransform                         = 0.2;
...
//    [self.view insertSubview:self.controlsView atIndex:(self.view.subviews.count-1)];
}

#pragma mark Actions

- (void)prepareControlsView {
    self.controlsConstraint.constant = -50.0;
    [self.controlsView layoutIfNeeded];
}

- (void)showControlsWithCompletion:(void(^)(void))completion {
    self.controlsConstraint.constant = 0.0;
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            if([self.delegate respondsToSelector:@selector(editImageViewController:didPressUseImageButton:withImage:)])
                [self.delegate editImageViewController:self didPressUseImageButton:sender withImage:transform];
        });
    });
}
